...
const AutoMute = ({ fftSize = 256, threshold = 20, timeout = 4000, showStats = true, startListening = true, muteOnlyAudio = false }) => {
    ...
    return (
        <div>
            ...
            <VideoPlayer isAudioDetected={isAudioDetected} muteOnlyAudio={muteOnlyAudio} showStats={showStats} />
        </div>
    );
};
